run_algorithm () {
    python run.py --algorithms $1 --model_name $1 --version_name spectralmpnn0_NoMP --processor_model spectralmpnn --model_args model_args/spectralmpnn_nomp.yaml --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name spectralmpnn1_NoMP --processor_model spectralmpnn --model_args model_args/spectralmpnn_nomp.yaml --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name spectralmpnn2_NoMP --processor_model spectralmpnn --model_args model_args/spectralmpnn_nomp.yaml --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name spectralmpnn3_NoMP --processor_model spectralmpnn --model_args model_args/spectralmpnn_nomp.yaml --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name spectralmpnn4_NoMP --processor_model spectralmpnn --model_args model_args/spectralmpnn_nomp.yaml --batch_size $2
}
