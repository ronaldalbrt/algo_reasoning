run_algorithm () {
    python run.py --algorithms $1 --model_name $1 --version_name gat0 --processor_model gat --batch_size $2 --nb_triplet_fts 0
    python run.py --algorithms $1 --model_name $1 --version_name gat1 --processor_model gat --batch_size $2 --nb_triplet_fts 0
    python run.py --algorithms $1 --model_name $1 --version_name gat2 --processor_model gat --batch_size $2 --nb_triplet_fts 0
    python run.py --algorithms $1 --model_name $1 --version_name gat3 --processor_model gat --batch_size $2 --nb_triplet_fts 0
    python run.py --algorithms $1 --model_name $1 --version_name gat4 --processor_model gat --batch_size $2 --nb_triplet_fts 0
}
