run_algorithm () {
    python run.py --algorithms $1 --model_name $1 --version_name specformer0 --processor_model specformer --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name specformer1 --processor_model specformer --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name specformer2 --processor_model specformer --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name specformer3 --processor_model specformer --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name specformer4 --processor_model specformer --batch_size $2
}
