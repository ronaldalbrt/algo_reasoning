run_algorithm () {
    python run.py --algorithms $1 --model_name $1 --version_name s2gnn0 --processor_model s2gnn --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name s2gnn1 --processor_model s2gnn --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name s2gnn2 --processor_model s2gnn --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name s2gnn3 --processor_model s2gnn --batch_size $2
    python run.py --algorithms $1 --model_name $1 --version_name s2gnn4 --processor_model s2gnn --batch_size $2
}
