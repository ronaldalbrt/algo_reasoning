...
# Algorithms not used: ['bridges', 'lcs_length', 'naive_vertex_cover']
...
if __name__ == '__main__':
    ...
    ap.add_argument('--algorithms', default=["graham_scan"], type=list_of_strings, help="Algorithms for the model to be trained on.")
    ...
    ap.add_argument('--model_name', default="GrahamScan_NotPretrained_NoHints", type=str, help="Model's name")
